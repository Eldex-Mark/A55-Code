...
void CoreA55_CoreMessaging_refresh () {
    CoreMessaging_refresh( GUI_API_VariableDescriptors, COREMESSAGING_ENDPOINT__CORE_M33 );  //CoreA55_CoreMessaging_refresh();  //CoreMessaging_sendValue( GUI_Version, GUI_API_VARIABLE_ID__GUI_Version );
