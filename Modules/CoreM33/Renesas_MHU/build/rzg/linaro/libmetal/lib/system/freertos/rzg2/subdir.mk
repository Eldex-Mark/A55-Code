...
C_SRCS += \
../rzg/linaro/libmetal/lib/system/freertos/rzg2/sys.c 

LST += \
sys.lst 

C_DEPS += \
./rzg/linaro/libmetal/lib/system/freertos/rzg2/sys.d 

OBJS += \
./rzg/linaro/libmetal/lib/system/freertos/rzg2/sys.o 
...
rzg/linaro/libmetal/lib/system/freertos/rzg2/%.o: ../rzg/linaro/libmetal/lib/system/freertos/rzg2/%.c
	@echo 'Building file: $<'
